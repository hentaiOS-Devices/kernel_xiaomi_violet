...
#define TAS2563_InterruptConfiguration_PININTConfig10_AssertOnLiveInterrupts   \
	(0x0 << 0)
#define TAS2563_InterruptConfiguration_PININTConfig10_AssertOnLatchedInterrupts \
	(0x1 << 0)
#define TAS2563_InterruptConfiguration_PININTConfig10_Assert2msOnLiveInterrupts \
	(0x2 << 0)
#define TAS2563_InterruptConfiguration_PININTConfig10_Assert2msOnLatchedInterrupts \
	(0x3 << 0)
...
struct tas2563_priv {
	...
	bool mbBypassTMax;
	int (*read)(struct tas2563_priv *pTAS2563, unsigned int reg,
		    unsigned int *pValue);
	int (*write)(struct tas2563_priv *pTAS2563, unsigned int reg,
		     unsigned int Value);
	int (*bulk_read)(struct tas2563_priv *pTAS2563, unsigned int reg,
			 unsigned char *pData, unsigned int len);
	int (*bulk_write)(struct tas2563_priv *pTAS2563, unsigned int reg,
			  unsigned char *pData, unsigned int len);
	int (*update_bits)(struct tas2563_priv *pTAS2563, unsigned int reg,
	...
	int (*set_calibration)(struct tas2563_priv *pTAS2563, int calibration);
